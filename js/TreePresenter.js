    ...
    createClass(Presenter, [{
        ...
        */
        ...
        value: function createDownloadWindow() {
            ...
            download.innerHTML = '\n                    <div id="tp-download-wrap">\n                        <h1>Download</h1>\n\n                        <div>\n                            <h2>PDF</h2>\n                            <button id="tp-download-pdf">&#11015;</button>\n                        </div>\n                        <div>\n                            <h2>LaTeX</h2>\n                            <button id="tp-download-latex">&#11015;</button>\n                        </div>\n                        <div>\n                            <h2>HTML</h2>\n                            <button id="tp-download-html">&#11015;</button>\n                        </div>\n                    </div>';
        ...
        value: function createIcons() {
            ...
            icons.innerHTML = '\n                    <i class="fa fa-question-circle" id="tp-icon-help"></i>\n                    <i class="fa fa-arrow-circle-down" id="tp-icon-download"></i>\n                    <i class="fa fa-cog" id="tp-icon-settings"></i>\n                    <i class="fa fa-map" id="tp-icon-map"></i>\n                    ';
